  ...
  <script>
	  ...
	  $('#loading').modal('show');
	  window.location.href = "${assets_path}/search.htm?keyword=" + keyword;
	});
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-body">
                <div class="py-3 text-center">
                    <i class="ni ni-bell-55 ni-3x"></i>
                    <h4 class="heading mt-4">${errorMessage}</h4>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-link text-white ml-auto" data-dismiss="modal">知道了</button>
				        ...
				        <form role="form" action="${assets_path}/user/login.htm" method="POST" AUTOCOMPLETE="off">
				            <div class="form-group mb-3">
				                <div class="input-group input-group-alternative">
				                    ...
				                    <input class="form-control" placeholder="账号" name="account" type="text">
				                </div>
				            </div>
				            <div class="form-group">
				                <div class="input-group input-group-alternative">
				            ...
				            <div class="text-center">
				                <button type="submit" class="btn btn-primary my-4">保存</button>
				                <button type="button" class="btn btn-outline-secondary" onclick="$('#user-modal').modal('hide')">取消</button>
				            </div>
				        </form>
				    </div>
				</div>
